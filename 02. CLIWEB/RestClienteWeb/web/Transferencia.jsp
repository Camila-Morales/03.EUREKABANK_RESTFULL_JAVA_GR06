...
<body>
    <div class="container">
        <div class="input-group">
            ...
            <input type="text" id="cuentaOrigen" placeholder="Ingrese cuenta origen">
        </div>
        <div class="input-group">
            <label for="cuentaDestino">Cuenta Destino:</label>
            <input type="text" id="cuentaDestino" placeholder="Ingrese cuenta destino">
        </div>
        <div class="input-group">
            <label for="importe">Monto:</label>
            <input type="number" id="importe" placeholder="Ingrese el monto">
        </div>
        <button class="btn" onclick="realizarTransferencia()">Transferir</button>
    </div>
